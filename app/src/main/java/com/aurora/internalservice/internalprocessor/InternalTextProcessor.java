...
public class InternalTextProcessor implements InternalService {
     ...
     */
    @Override
    public InternallyProcessedFile processFile(InputStream file, String fileRef) throws FileTypeNotSupportedException {
        Log.d("InternalTextProcessor", "Not implemented yet!");
