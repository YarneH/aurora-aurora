...
public class TranslatorUnitTest {
    ...
    public void Translator_makeUrl_CorrectURLIsMade() throws UnsupportedEncodingException {
        ...
        String answer = "https://translation.googleapis.com/language/translate/v2?q=this+is+a+test&q=what+a+cool+test" +
                "&q=with+escape+characters+%2F+%2B+" +
                ".+&q=how+does+that+translate&target=nl&source=en&key=AIzaSyBT0I7M_hZlTmpD1hqC8beY1ILzpWGSU4s&format" +
                "=text";
